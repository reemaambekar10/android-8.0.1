;(function (window, undefined) { 
  var prelude = {} // create "prelude" namespace
    ...
    , functional = freeExports ? nrequire('/support/FunctionalJS/functional') : window.functional
  ...
  // Named as trimStr to not confuse trim in domain
  //+ trimStr :: String -> String
    , trimStr = function(str) {
        return String(str).trim();
      }

  //+ formFieldToNumber :: String -> String
    , formFieldToNumber = function(str) {
  ...
  prelude.empty = empty;
  prelude.trimStr = trimStr;
  prelude.formFieldToNumber = formFieldToNumber;
